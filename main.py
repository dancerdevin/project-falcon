...
def zipcode_to_output(zip: int, output):
    ...
    rentometer_result = rentometer_api(lat_long, output, from_cache=True)
    print(rentometer_result)
    rentcast_result = rentcast_api(98408, 100, output, from_cache=True)
    print(rentcast_result)
...
if __name__ == "__main__":
   zipcode_to_output(98408, "gsheets")